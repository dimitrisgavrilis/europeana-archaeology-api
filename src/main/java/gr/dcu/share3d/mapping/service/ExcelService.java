...
import gr.dcu.share3d.mapping.repository.AatSubjectRepository;
import java.io.File;
...
//            }
     ...
     * @throws IOException 
     */
    public void exportMappingTermsToExcel(String filename, List<MappingTerm> terms) throws IOException {
...
//                        .setCellValue(employee.getSalary());
            ...
            Path uploadDirPath = Paths.get(fileStorageService.getFileStorageProperties().getUploadDir()).toAbsolutePath().normalize();
